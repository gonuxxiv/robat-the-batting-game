...
public class ForeGroundPoolerFarther : MonoBehaviour
{
    ...
    #region Singleton
    public static ForeGroundPoolerFarther Instance;
    ...
    {   
        ...
        unpreparedList.Add(preparedList[0]);
        preparedList.RemoveAt(0);
